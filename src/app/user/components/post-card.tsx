...
interface PostCardProps {
  postDetail: Post;
  books?: { id: number; title: string; cover_image_url: string }[];
  genres?: { id: number; name: string }[];
}

const PostCard: React.FC<PostCardProps> = ({ postDetail, books = [], genres = [] }) => {
  ...
  const handleLikeToggle = async () => {
    ...
    try {
      ...
      setIsLiked(is_like);
      const like_cnt = await getLikeCount(postDetail.id);
  ...
  // Determine tag based on book_id or genre_id
